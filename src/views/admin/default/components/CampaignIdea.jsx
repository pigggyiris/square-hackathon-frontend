...
const CampaignIdea = () => {
  ...
  return (
    <Card extra="!p-[20px] text-left overflow-hidden h-auto">
  ...
  <div className="col-span-2">
    <Bubble title={ideas[0].title} content={ideas[0].content} color={ideas[0].color} />
    </div>
      <Bubble title={ideas[1].title} content={ideas[1].content} color={ideas[1].color} />
   
  </div>
  <div className="grid grid-cols-5 gap-4">
    <div className="col-span-2">
      <Bubble title={ideas[2].title} content={ideas[2].content} color={ideas[2].color} />
    </div>
    <div className="col-span-3">
      <Bubble title={ideas[3].title} content={ideas[3].content} color={ideas[3].color} />
    </div>
  </div>
  <div className="flex justify-center mt-4">
    <Bubble title={ideas[4].title} content={ideas[4].content} color={ideas[4].color} />
  </div>
</div>
