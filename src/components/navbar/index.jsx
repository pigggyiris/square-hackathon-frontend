  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-fall-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        <div className="flex h-full items-center rounded-full bg-lightPrimary text-fall-700 dark:bg-fall-900 dark:text-white xl:w-[225px]">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="block h-full w-full rounded-full bg-lightPrimary text-sm font-medium text-fall-700 outline-none placeholder:!text-fiord-400 dark:bg-fall-900 dark:text-white dark:placeholder:!text-white sm:w-fit"
          />
        </div>
        ...
        <IoMdNotificationsOutline className="h-4 w-4 text-fiord-600 dark:text-white" />
        <IoMdInformationCircleOutline className="h-4 w-4 text-fiord-600 dark:text-white" />
        <RiMoonFill className="h-4 w-4 text-fiord-600 dark:text-white" />
