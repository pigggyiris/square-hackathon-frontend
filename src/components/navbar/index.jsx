...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-40 flex w-full flex-row flex-wrap items-center justify-between bg-fall-150 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      <div></div>
      <div className="relative mt-[3px] flex h-[61px] flex-grow items-center justify-between gap-2 rounded-full px-2 py-2  shadow-shadow-500 dark:!bg-fall-800 dark:shadow-none md:flex-grow-0 md:gap-1 xl:gap-2">
